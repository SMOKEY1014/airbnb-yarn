            ...
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="p-8 grid gap-4 bg-black">
                    ...
                    {place?.photos?.length > 0 && place.photos.map(photo => (
                        <div key={photo}>
                            <img src={'https://smk-project.onrender.com/uploads/' + photo} alt={place.title} />
                        </div>
                    ))}
                </div>
            </div>
                    ...
                    {place.photos?.[0] && (
                        <div>
                            <img
                                ...
                                src={'https://smk-project.onrender.com/uploads/' + place.photos[0]}
                                alt={place.title}
                            />
                        </div>
                    )}
                ...
                <div className="grid h-4/5 grid-cols-1 md:grid-cols-2 gap-2">
                    {place.photos?.[1] && (
                        <img
                            ...
                            src={'https://smk-project.onrender.com/uploads/' + place.photos[1]}
                            alt={place.title}
                        />
                    )}
                    {place.photos?.[2] && (
                        <img
                            onClick={() => { setShowAllPhotos(true); }}
                            className="cursor-pointer object-cover w-full h-full"
                            src={'https://smk-project.onrender.com/uploads/' + place.photos[2]}
                            alt={place.title}
                        />
                    )}
                    {place.photos?.[3] && (
                        <img
                            onClick={() => { setShowAllPhotos(true); }}
                            className="cursor-pointer object-cover w-full h-full"
                            src={'https://smk-project.onrender.com/uploads/' + place.photos[3]}
                            alt={place.title}
                        />
                    )}
                    {place.photos?.[4] && (
                        <div className="relative">
                            <img
                                onClick={() => { setShowAllPhotos(true); }}
                                className="cursor-pointer object-cover w-full h-full"
                                src={'https://smk-project.onrender.com/uploads/' + place.photos[4]}
                                alt={place.title}
                            />
